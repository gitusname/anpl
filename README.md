...
* project manifest loading, source glob discovery, path-based external package dependencies, package-qualified imports, invalid manifest/source diagnostics, source-hash cache keys, and package-aware module graph checks
