...
__anpl_modules["crm"] = {
  createCustomer(id, name) {
    ...
    __locals["crm.createCustomer.id"] = __anpl_track_value(id);
    __locals["crm.createCustomer.name"] = __anpl_track_value(name);
    let __block = "crm.createCustomer.entry";
    while (true) {
      __anpl_check_runtime_limits();
      switch (__block) {
        case "crm.createCustomer.entry": {
          __values["%1"] = __anpl_track_value(__locals["crm.createCustomer.id"]);
          __values["%2"] = __anpl_track_value(__locals["crm.createCustomer.name"]);
          __values["%3"] = __anpl_track_value({ "id": __values["%1"], "name": __values["%2"] });
          return __values["%3"];
        }
      default:
